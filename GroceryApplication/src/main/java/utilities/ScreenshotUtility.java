...
public class ScreenshotUtility {
	...
	public void getScreenshot(WebDriver driver, String failedTestCase) throws IOException {
		...
		TakesScreenshot scrShot = (TakesScreenshot) driver;// TakesScreenshot Interface used to take screenshot
															// ,//convert webdriver to screenshot mode
		File screenShot = scrShot.getScreenshotAs(OutputType.FILE);// to capture the screenshot and store it as a
																	// temporary file
